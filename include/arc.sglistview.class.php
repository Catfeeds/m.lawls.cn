...

{
...

    {
...

        {
			...
			if(!empty($this->searchArr['skill']))
            {
				$naddQuery .= "AND arc.skill like '%{$this->searchArr['skill']}%'";
            }
...

    {
        ...
        global $nativeplace,$skill,$infotype,$keyword;
        ...
        $geturl = "tid=".$this->TypeID."&TotalResult=".$this->TotalResult."&nativeplace=$nativeplace&infotype=$infotype&skill=$skill&keyword=".urlencode($keyword)."&";
        ...
        $hidenform = "<input type='hidden' name='skill' value='$skill' />\r\n";
