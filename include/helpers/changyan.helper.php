...
function changyan_gen_sign($user)
{
    ...
    $aes_url=CHANGYAN_API_SIGN.'?platform=dedecms'.'&input='.$user."&version={$cfg_version}&formurl={$nurl}&phpver={$phpv}&os={$sp_os}&mysqlver={$mysql_ver}&cyver=".CHANGYAN_VER;
...
{
    global $dopost;
    $jquery_url = CHANGYAN_JQUERY; //CHANGYAN_API_AES."assets/js/jquery.min.js";
