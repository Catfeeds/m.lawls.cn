...
function PutInfo($msg1,$msg2)
{
    ...
    $msginfo = "<html>\n<head>
        ...
        <title>法易通法律法务 提示信息</title>
        <base target='_self'/>\n</head>\n<body leftmargin='0' topmargin='0'>\n<center>
        <br/>
        <div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #cccccc;border-top:1px solid #cccccc;border-right:1px solid #cccccc;background-color:#DBEEBD;'>法易通法律法务 提示信息！</div>
